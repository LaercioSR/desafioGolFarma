...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Desafio GolFarma - Editar Médico</title>
    ...
    <body>
        ...
        <div class="container content-tasknow">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action = "{{route('medico.update', $medico)}}" method = "POST" class="" id="form-tarefa">
                        @method('PUT')
                        @csrf
                        <div class="titulo centralizar">
                            ...
                            <br/>
                            <br/>
                            <p class="titulo-texto">Edição de Médico</p>
                        </div>
                        <div class = "form-group">
                            ...
                            <input type = "text" class = "form-control" id="nome" name="nome" maxlength="30" required value="{{$medico->nome}}">
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="crm">CRM</label>
                                <input type = "text" class = "form-control" id="crm" name="crm" maxlength="13" required value="{{$medico->crm}}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="telefone">Telefone</label>
                                <input type = "text" class = "form-control" id="telefone" name="telefone" maxlength="15" required value="{{$medico->telefone}}">
                            </div>
                        </div>
